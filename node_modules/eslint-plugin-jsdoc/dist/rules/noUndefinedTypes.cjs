...
var _default = exports.default = (0, _iterateJsdoc.default)(({
  ...
  .concat(cjsOrESMScope ? globalScope.childScopes.flatMap(({
    ...
    if (['ImportDefaultSpecifier', 'ImportNamespaceSpecifier', 'ImportSpecifier'].includes(/** @type {import('estree').Identifier & {parent: {type: string}}} */identifiers?.[0]?.parent?.type)) {
      imports.push(name);
    }
    return name;
    /* c8 ignore next */
