...
<template>
  <div>
    ...
    <MeModal ref="modalRef" title="Thiết lập bố cục" :show-footer="false" width="600px">
      ...
      <p class="mt-16 opacity-50">
        Lưu ý: Thiết lập này chỉ có hiệu lực đối với các trang không thiết lập layout hoặc thiết lập theo hệ thống, layout được thiết lập trong menu có độ ưu tiên cao nhất
      </p>
    </MeModal>
  </div>
</template>
